...
type Exercise struct {
	...
	MusclePortions        []MusclePortionE         `json:"muscles" gorm:"many2many:exercise_muscle_portions;foreignKey:Id;joinForeignKey:ExerciseId;References:Id;"`
	ExerciseMusclePortion []ExerciseMusclePortionE `json:"musclesAndRoles"`
	Link                  string                   `json:"link"`
	CreatedAt             time.Time                `json:"createdAt" gorm:"column:createdAt;autoCreateTime"`
	UpdatedAt             time.Time                `json:"updatedAt" gorm:"column:updatedAt;autoUpdateTime"`
}

type ExerciseMusclePortionE struct {
	Id              int            `json:"-"        gorm:"primaryKey;autoIncrement;"`
	ExerciseId      int            `json:"-"`
	Exercise        Exercise       `json:"-"`
	MusclePortionId int            `json:"-" gorm:"column:muscle_id"`
	MusclePortion   MusclePortionE `json:"muscle"`
